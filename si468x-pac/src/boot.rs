...
impl Serialize for BootRequest {
...
impl Deserialize<Self> for BootResponse {

    fn deserialize(buf: &[u8]) -> Result<BootResponse, DeviceError> {
...
impl BootRequest {
pub fn send<SPI: SpiDevice>(&self, spi: &mut SPI) -> Result<BootResponse, DeviceError> {
...
impl<SPI: SpiDevice> Transmit<SPI, BootResponse> for BootRequest {}

impl Command for BootRequest {
    fn opcode(&self) -> u8 {
        0x7
    }
}